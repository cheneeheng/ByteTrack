...
class STrack(BaseTrack):
    ...
    def activate(self, kalman_filter, frame_id, det_id):
    ...
    def re_activate(self, new_track, frame_id, det_id, new_id=False):
    ...
    def update(self, new_track, frame_id, det_id):
        """
...
class BYTETracker(object):
    ...
    def update(self, output_results: np.ndarray, *args, **kwargs):
        ...
        matches, u_track, u_detection_second = matching.linear_assignment(dists, thresh=0.5)  # noqa
        for itracked, idet in matches:
        ...
        '''Deal with unconfirmed tracks, usually tracks with only one beginning frame'''  # noqa
        ...
        self.tracked_stracks, self.lost_stracks = remove_duplicate_stracks(self.tracked_stracks, self.lost_stracks)  # noqa
        # get scores of lost tracks
        output_stracks = [track for track in self.tracked_stracks if track.is_activated]  # noqa
